...
class ReportController extends GetxController{
  ...
  void cardOrderPage(String orderId, String deliveryFee, String tip, String bonus, String customerName, String status) {
    Get.toNamed('/report_order_detail', arguments: {'order': orderId, 'delivery_fee': deliveryFee, 'tip': tip, 'bonus': bonus, 'customerName': customerName, 'status': status});
  }
}